...
**mmve Viewer** is a qualitative comparison tools to facilitate your research.
...
mmve Viewer works on Linux, Windows and macOS. It requires:
...
```shell
git clone https://github.com/open-mmlab/mmve.git
```
...
We appreciate all contributions to improve mmve Viewer. You can create your issue to report bugs or request new features. Welcome to give us suggestions or contribute your codes.
