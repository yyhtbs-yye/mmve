...
from mmve.registry import VISBACKENDS


@VISBACKENDS.register_module()
class VisBackend(BaseVisBackend):
    """mmve visualization backend class. It can write image, config, scalars,
    ...
    Examples:
        >>> from mmve.visualization import VisBackend
        >>> import numpy as np
...
class WandbVisBackend(BaseWandbVisBackend):
    """Wandb visualization backend for mmve."""
