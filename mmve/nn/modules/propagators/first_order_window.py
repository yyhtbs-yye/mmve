...
from mmve.nn.utils import flow_warp, make_layer
...
class FirstOrderWindowPropagator(BaseModule):
    ...
    def forward(self, curr_feats, flows, prev_feats=[]):
        ...
        for i in range(0, t):
            ...
            align_feat = self.refiner(n1_feat, n1c_cond, [n1_flow])
...
class FirstOrderrefiner(BaseModule):
    def __init__(self):
        super().__init__()
