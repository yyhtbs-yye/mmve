...
def build_mmve_wrapper_tomesd_block(block_class: Type[torch.nn.Module]
                                      ) -> Type[torch.nn.Module]:
    """Make a patched class for a DiffusersWrapper model in mmve. This patch
...
def build_mmve_tomesd_block(block_class: Type[torch.nn.Module]
                              ) -> Type[torch.nn.Module]:
    """Make a patched class for a mmve StableDiffusion model. This patch
    applies ToMe to the forward function of the block.
