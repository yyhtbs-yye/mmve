...
from mmve.utils.typing import ForwardInputs, LabelVar
from mmve.nn.utils import get_valid_num_batches, label_sample_fn
...
class BaseConditionalGAN(BaseGAN):
    ...
    Args:
        ...
        data_preprocessor (Optional[Union[dict, Config]]): The pre-process
            config or :class:`~mmve.nn.DataPreprocessor`.
