...
from mmve.utils import get_sampler
...
class VisualizationHook(Hook):
    """mmve Visualization Hook. Used to visual output samples in training,
    ...
    - Required key words:
        - 'type': Value must be string. Denotes what kind of sampler is used to
            generate image. Refers to :meth:`~mmve.utils.get_sampler`.
    ...
    models supported in mmve. Refers to
