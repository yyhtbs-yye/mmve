...
from mmve.registry import OPTIM_WRAPPER_CONSTRUCTORS
...
class SinGANOptimWrapperConstructor:
    ...
    :class:`~mmve.editors.singan.SinGANMultiScaleGenerator` and
    :class:`~mmve.editors.singan.SinGANMultiScaleDiscriminator`.
