...
from mmve.registry import LOOPS
...
class MultiValLoop(BaseLoop):
    """Validation loop for mmve models which support evaluate multiply
...
class MultiTestLoop(BaseLoop):
    """Test loop for mmve models which support evaluate multiply dataset at
