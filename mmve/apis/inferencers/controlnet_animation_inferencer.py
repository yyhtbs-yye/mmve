...
from mmve.registry import DIFFUSION_SCHEDULERS, MODELS
from mmve.utils import ConfigType
from .base_mmve_inferencer import BaseMmveInferencer
...
class ControlnetAnimationInferencer(BaseMmveInferencer):
    """Base inferencer.
