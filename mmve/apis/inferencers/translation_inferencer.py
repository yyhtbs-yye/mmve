...
from mmve.base_models import BaseTranslationModel
from .base_mmve_inferencer import BaseMmveInferencer, InputsType, PredType


class TranslationInferencer(BaseMmveInferencer):
