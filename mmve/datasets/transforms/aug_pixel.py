...
from mmve.registry import TRANSFORMS
...
class ColorJitter(BaseTransform):
    """An interface for torch color jitter so that it can be invoked in mmve
    pipeline.
...
class RandomAffine(BaseTransform):
    ...
    def _get_params(degrees, translate, scale_ranges, shears, flip_ratio,
        ...
        # See https://github.com/open-mmlab/mmve/pull/799 for more detail
