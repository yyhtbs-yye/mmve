...
from mmve.registry import EVALUATORS
...
class Evaluator(Evaluator):
    ...
    Score (IS, :class:`~mmve.evaluation.InceptionScore`) only needs to
    take fake images as input. However, Frechet Inception Distance (FID,
    :class:`~mmve.evaluation.FrechetInceptionDistance`) needs to take
    ...
    :class:`~mmve.evaluation.PerceptualPathLength`), generator need
    ...
    :meth:`mmve.engine.runner.MultiValLoop.run` and
    :meth:`mmve.engine.runner.MultiTestLoop.run`.
